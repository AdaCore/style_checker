...
from asclib.checkers.rulific.first_line_comment import FirstLineCommentRuleChecker
...
from asclib.checkers.rulific.no_tab_indentation import NoTabIndentationRuleChecker
