...
Driver for the AdaCore Style Checker (ASC) testsuite.
"""
...
def main():
    ...
    # that, should the style_checker leak any file/directories,
    # we can (1) detect them, and (2) delete them.
    #
    ...
    # information to the testcase through the ASC_TESTSUITE_TMP
    # environment variable.
    m.options.tmp = mkdtemp('', 'asc-TS-', m.options.tmp)
    os.environ['ASC_TESTSUITE_TMP'] = m.options.tmp
